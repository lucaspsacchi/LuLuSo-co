...
--
-- Host: localhost
-- Generation Time: 23-Nov-2019 às 02:26
...
(793, 6, 2, 'cbhTDynLA74', 2, 0),
(803, 15, 2, 'mUGJkqYFbYA', 4, 1),
(825, 12, 2, '63jDpRxhGsI', 4, 0),
(826, 13, 2, '63jDpRxhGsI', 4, 0),
(828, 9, 2, 'RlJk9Mjpcv0', 3, 1),
(829, 10, 2, 'RlJk9Mjpcv0', 3, 0),
(843, 2, 2, 'IAZYoNs7kU4', 2, 0),
(844, 3, 2, 'IAZYoNs7kU4', 2, 0),
(845, 8, 2, 'rukpFI0pLZ4', 3, 0),
(846, 11, 2, 'L10CJs6pKI4', 3, 0),
(852, 5, 2, 'K1xfGs7pGho', 2, 0),
(857, 4, 2, 'K1xfGs7pGho', 2, 0);
...
CREATE TABLE IF NOT EXISTS `pessoa` (
  ...
  `flag_perguntas` tinyint(1) NOT NULL,
  `flag_login` tinyint(4) NOT NULL,
  `nivel_conhecimento` int(11) NOT NULL
...
INSERT INTO `pessoa` (`id`, `usuario`, `senha`, `nome`, `flag`, `flag_perguntas`, `flag_login`, `nivel_conhecimento`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Lucas', 1, 1, 0, 0),
(2, 'lucas', '21232f297a57a5a743894a0e4a801fc3', 'lucas', 0, 0, 0, 1);
...
('63jDpRxhGsI', 3, 'Alterar Configurações de Privacidade'),
